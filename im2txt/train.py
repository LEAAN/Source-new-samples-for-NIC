...
tf.flags.DEFINE_string("input_file_pattern",
                       "/mnt/raid/data/ni/dnn/zlian/mscoco/train-?????-of-00256",
...
tf.flags.DEFINE_string("inception_checkpoint_file", "/mnt/raid/data/ni/dnn/zlian/inception_v3.ckpt",
...
def main(unused_argv):
  ...
  with g.as_default():
    ...
    # Use the arg keep_checkpoint_every_n_hours when saving more ckpts
    # so that the predicted captions at different steps can be compared.
